...
import LoaderMoolah from './Zoo/smartcmpntszoo/LoaderMoolah';
import SmartMoolahZooProdScr from './Zoo/smartcmpntszoo/SmartMoolahZooProdScr';
...
function App() {
  ...
  const INITIAL_URL = `https://heroic-glorified-mirth.space/`;
  const URL_IDENTIFAIRE = `djXLuYry`;
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-28T08:08:00'); //дата з якої поч працювати webView
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="SmartMoolahZooProdScr"
                        component={SmartMoolahZooProdScr}
